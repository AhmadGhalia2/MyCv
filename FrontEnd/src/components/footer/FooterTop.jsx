...
export default function FooterTop() {
  return (
    ...
    <aside class="right">
      <div className="icons">
        <a href='https://www.facebook.com'><box-icon name="facebook-circle" type="logo" flip="horizontal" animation="tada" color="#0866FF"></box-icon></a>
        <a href='https://www.instagram.com'>  <box-icon name="instagram-alt" type="logo" animation="tada" flip="horizontal" color="#E1306C"></box-icon></a>
